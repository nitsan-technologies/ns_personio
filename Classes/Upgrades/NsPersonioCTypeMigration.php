...
namespace NITSAN\NsPersonio\Upgrades;
 ...
 */
#[UpgradeWizard('NsPersonioCTypeMigration')]
class NsPersonioCTypeMigration implements UpgradeWizardInterface
{
    protected function getListTypeToCTypeMapping(): array
    {
        return [
            'nspersonio_pi1' => 'nspersonio_pi1',
            'nspersonio_pi2' => 'nspersonio_pi2',
            'nspersonio_pi3' => 'nspersonio_pi3',
        ];
    }
    public function getTitle(): string
    {
        return 'Migrate "NS Personio" plugins to content elements.';
    }
    public function getDescription(): string
    {
        return 'The "NS Personio" plugins are now registered as content elements. Update migrates existing records and backend user permissions.';
    }
