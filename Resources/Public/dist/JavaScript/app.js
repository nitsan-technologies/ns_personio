  ...
  if (document.getElementById('fileProcessLink')) {
    ...
    document.getElementById("apply-form").addEventListener("submit", function (e) {
      ...
      if (responArr.length == 0 && flag == false) {
        ...
        for (var index = 0; index < responArr.length; index++) {
          allValues += "\"".concat(index, "\"") + ":" + responArr[index];
      ...
      var allOtherValues = [];
      if (responArrOther) {
        for (var i = 0; i < responArrOther.length; i++) {
          allOtherValues += "\"".concat(i, "\"") + ":" + responArrOther[i];
...
function isotopFilter() {
  ...
  if (jobsData) {
    jobsData.forEach(function ($grid) {
      if ($grid.classList.contains('ns-personio-jobs')) {
...
var paginationWrapMain = document.getElementById('paginationWrap');
var isotopCategory = document.getElementById('jobs-tabs');
if (filterButton) {
  filterButton.addEventListener('click', function (e) {
    ...
    http.onreadystatechange = function () {
      if (http.readyState === 4 && http.status === 200) {
        ...
        // Get the new items
        // Render the items
        if (doc.getElementById('paginationWrap')) {
          paginationWrapMain.innerHTML = doc.getElementById('paginationWrap').innerHTML;
        }
        jobs.innerHTML = doc.getElementById('jobs-results').innerHTML;
        isotopCategory.innerHTML = doc.getElementById('jobs-tabs').innerHTML;
        isotopFilter();
      }
    };
    http.send(data);
