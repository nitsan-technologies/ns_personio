...
!function (e, t) {
    ...
    const i = e => (e = e.filter(Boolean)).length < 2 ? e[0] || "" : 1 == l(e) ? "[" + e.join("") + "]" : "(?:" + e.join("|") + ")",
        ...
        l = e => e.reduce(((e, t) => Math.max(e, a(t))), 0), a = e => c(e).length, c = e => Array.from(e), d = e => {
    ...
    const v = new RegExp(Object.keys(g).join("|") + "|[̀-ͯ·ʾʼ]", "gu"), m = (e, t = "NFKD") => e.normalize(t),
        y = e => c(e).reduce(((e, t) => e + b(t)), ""),
        b = e => (e = m(e).toLowerCase().replace(v, (e => g[e] || "")), m(e, "NFC"))
    const O = e => {
        const t = {}, i = (e, i) => {
    ...
    class S {
        ...
        clone(e, t) {
            let i = new S, s = JSON.parse(JSON.stringify(this.parts)), n = s.pop()
    ...
    }, V = e => "string" == typeof e && e.indexOf("<") > -1, q = (e, t) => {
    ...
    const Y = e => null == e ? null : Z(e), Z = e => "boolean" == typeof e ? e ? "1" : "0" : e + "",
        ...
        }, le = e => e.replace(/[\\"']/g, "\\$&"), ae = (e, t) => {
            t && e.append(t)
        }

    function ce(e, t) {
        var i = Object.assign({}, X, t), s = i.dataAttr, n = i.labelField, o = i.valueField, r = i.disabledField,
        ...
        return "select" === d ? (h = y.options, g = {}, f = 1, v = e => {
            ...
            var t, i, s
            "optgroup" === (p = e.tagName.toLowerCase()) ? ((s = v(t = e))[a] = s[a] || t.getAttribute("label") || "", s[c] = s[c] || f++, s[r] = s[r] || t.disabled, y.optgroups.push(s), i = s[c], j(t.children, (e => {
                m(e, i)
            }))) : "option" === p && m(e)
        }))) : (() => {
            const t = e.getAttribute(s)
            if (t) y.options = JSON.parse(t), j(y.options, (e => {
                y.items.push(e[o])
            }))
            else {
                var r = e.value.trim() || ""
    ...
    class ue extends (function (e) {
        ...
        constructor(e, t) {
            ...
            const r = N("<div>"), l = N("<div>"), a = this._render("dropdown"),
                c = N('<div role="listbox" tabindex="-1">'), d = this.input.getAttribute("class") || "", u = n.mode
            var p
            if (H(r, n.wrapperClass, d, u), H(l, n.controlClass), ae(r, l), H(a, n.dropdownClass, u), n.copyClassesToDropdown && H(a, d), H(c, n.dropdownContentClass), ae(a, c), N(n.dropdownParent || r).appendChild(a), V(n.controlInput)) {
                p = N(n.controlInput)
            ...
            } else n.controlInput ? (p = N(n.controlInput), this.focus_node = p) : (p = N("<input/>"), this.focus_node = l)
        ...
        setup() {
            ...
            (null === t.maxItems || t.maxItems > 1) && e.is_select_tag && G(a, {multiple: "multiple"}), t.placeholder && G(i, {placeholder: t.placeholder}), !t.splitOn && t.delimiter && (t.splitOn = new RegExp("\\s*" + r(t.delimiter) + "+\\s*")), t.load && t.loadThrottle && (t.load = te(t.load, t.loadThrottle)), e.control_input.type = a.type, ne(s, "mousemove", (() => {
                e.ignoreHover = !1
            })), ne(s, "mouseenter", (t => {
            ...
            ne(document, "mousedown", v), ne(window, "scroll", m, d), ne(window, "resize", m, d), this._destroy = () => {
                ...
                tabIndex: a.tabIndex
            }, a.tabIndex = -1, a.insertAdjacentElement("afterend", e.wrapper), e.sync(!1), t.items = [], delete t.optgroups, delete t.options, ne(a, "invalid", (() => {
                e.isValid && (e.isValid = !1, e.isInvalid = !0, e.refreshState())
            })), e.updateOriginalInput(), e.refreshItems(), e.close(!1), e.inputState(), e.isSetup = !0, a.disabled ? e.disable() : e.enable(), e.on("change", this.onChange), H(a, "tomselected", "ts-hidden-accessible"), e.trigger("initialize"), !0 === t.preload && e.preload()
        }
            ...
            if (t.ignoreHover = !0, t.isLocked) 9 !== e.keyCode && se(e)
                ...
                switch (e.keyCode) {
                    ...
                    case 38:
                        ...
                        return void se(e)
                    case 13:
                        return void (t.canSelect(t.activeOption) ? (t.onOptionSelect(e, t.activeOption), se(e)) : (t.settings.create && t.createItem() || document.activeElement == t.control_input && t.isOpen) && se(e))
                    case 37:
                        return void t.advanceSelection(-1, e)
                    case 39:
                        return void t.advanceSelection(1, e)
                    case 9:
                        return void (t.settings.selectOnTab && (t.canSelect(t.activeOption) && (t.onOptionSelect(e, t.activeOption), se(e)), t.settings.create && t.createItem() && se(e)))
                    case 8:
                    case 46:
        ...
        setTextboxValue(e = "") {
            ...
            t.value !== e && (t.value = e, q(t, "update"), this.lastValue = e)
        }
        ...
        clearActiveOption() {
            this.activeOption && (z(this.activeOption, "active"), G(this.activeOption, {"aria-selected": null})), this.activeOption = null, G(this.focus_node, {"aria-activedescendant": null})
        }
        ...
        selectAll() {
            ...
            t.length && (e.hideInput(), e.close(), e.activeItems = t, E(t, (t => {
        ...
        refreshOptions(e = !0) {
            ...
            for (f && (y = h.activeOption) && (c = y.closest("[data-group]")), n = m.items.length, "number" == typeof h.settings.maxOptions && (n = Math.min(n, h.settings.maxOptions)), n > 0 && (b = !0), t = 0; t < n; t++) {
                ...
                for (h.settings.hideSelected || d.classList.toggle("selected", h.items.includes(a)), o = l[h.settings.optgroupField] || "", i = 0, s = (r = Array.isArray(o) ? o : [o]) && r.length; i < s; i++) {
                    ...
                    let e = u[o]
                    void 0 === e && (e = document.createDocumentFragment(), p.push(o)), i > 0 && (d = d.cloneNode(!0), G(d, {
                        id: l.$id + "-clone-" + i,
                        "aria-selected": null
                    }), d.classList.add("ts-cloned"), z(d, "active"), h.activeOption && h.activeOption.dataset.value == n && c && c.dataset.group === o.toString() && (y = d)), e.appendChild(d), u[o] = e
                }
            }
            ...
            })), m.query.length && m.tokens.length && E(m.tokens, (e => {
                J(O, e.regex)
            })))
            var w = e => {
        ...
        updateOriginalInput(e = {}) {
            ...
            if (t.is_select_tag) {
                ...
                function l(e, i, s) {
                    return e || (e = N('<option value="' + ee(i) + '">' + ee(s) + "</option>")), e != n && t.input.append(e), o.push(e), (e != n || r > 0) && (e.selected = !0), e
                }
                ...
                t.input.querySelectorAll("option:checked").forEach((e => {
                    ...
                    if (i = t.options[e], s = i[t.settings.labelField] || "", o.includes(i.$option)) {
                        l(t.input.querySelector(`option[value="${le(e)}"]:not(:checked)`), e, s)
        ...
        open() {
            var e = this
            e.isLocked || e.isOpen || "multi" === e.settings.mode && e.isFull() || (e.isOpen = !0, G(e.focus_node, {"aria-expanded": "true"}), e.refreshState(), D(e.dropdown, {
                visibility: "hidden",
                display: "block"
            }), e.positionDropdown(), D(e.dropdown, {
                visibility: "visible",
                display: "block"
        ...
        close(e = !0) {
            ...
            e && (t.setTextboxValue(), "single" === t.settings.mode && t.items.length && t.hideInput()), t.isOpen = !1, G(t.focus_node, {"aria-expanded": "false"}), D(t.dropdown, {display: "none"}), t.settings.hideSelected && t.clearActiveOption(), t.refreshState(), i && t.trigger("dropdown_close", t.dropdown)
        }
        ...
        positionDropdown() {
            if ("body" === this.settings.dropdownParent) {
                ...
                D(this.dropdown, {width: t.width + "px", top: i + "px", left: s + "px"})
            }
        }
        ...
        render(e, t) {
            ...
            if (s = N(s), "option" === e || "option_create" === e ? t[n.settings.disabledField] ? G(s, {"aria-disabled": "true"}) : G(s, {"data-selectable": ""}) : "optgroup" === e && (i = t.group[n.settings.optgroupValueField], G(s, {"data-group": i}), t.group[n.settings.disabledField] && G(s, {"data-disabled": ""})), "option" === e || "item" === e) {
                const i = Z(t[n.settings.valueField])
                G(s, {"data-value": i}), "item" === e ? (H(s, n.settings.itemClass), G(s, {"data-ts-item": ""})) : (H(s, n.settings.optionClass), G(s, {
                    role: "option",
                    id: t.$id
    ...
    return ue.define("change_listener", (function () {
        ne(this.input, "change", (() => {
            this.sync()
        }))
    })), ue.define("checkbox_options", (function (e) {
        ...
        t.hook("after", "setupTemplates", (() => {
            ...
            t.settings.render.option = (i, o) => {
                var r = N(e.call(t, i, o)), l = document.createElement("input")
            ...
            if (s.classList.contains("selected")) return s.classList.remove("selected"), t.removeItem(s.dataset.value), t.refreshOptions(), void se(e, !0)
            i.call(t, e, s), o(s)
        }))
        ...
        if ("multi" === e.settings.mode) {
            ...
            e.hook("instead", "lock", (() => {
                ...
                var t = $(e.control).sortable({
                    items: "[data-value]", forcePlaceholderSize: !0, disabled: e.isLocked, start: (e, i) => {
        ...
        t.on("initialize", (() => {
            var e = N(i.html(i)), s = e.querySelector("." + i.closeClass)
        ...
        e.settings.shouldOpen = !0, e.hook("before", "setup", (() => {
            ...
            })), ne(e.control_input, "blur", (() => e.onBlur())), e.hook("before", "close", (() => {
        ...
        if (t.append) {
            ...
            i.hook("after", "setupTemplates", (() => {
                ...
                i.settings.render.item = (t, n) => {
                    var o = N(e.call(i, t, n)), r = N(s)
                    return o.appendChild(r), ne(r, "mousedown", (e => {
                        se(e, !0)
                    })), ne(r, "click", (e => {
